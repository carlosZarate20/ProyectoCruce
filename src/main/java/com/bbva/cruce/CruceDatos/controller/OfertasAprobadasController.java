package com.bbva.cruce.CruceDatos.controller;
...
import com.bbva.cruce.CruceDatos.model.CargaOfertas;
import com.bbva.cruce.CruceDatos.model.OfertasAprobadasPlantilla;
import com.bbva.cruce.CruceDatos.model.RespuestaWS;
import com.bbva.cruce.CruceDatos.service.impl.OfertasAprobadasServiceImpl;
...
public class OfertasAprobadasController {
	...
	@Autowired
	private OfertasAprobadasServiceImpl ofertasAprobadasService;
	...
	public RespuestaWS<List<OfertasAprobadasPlantilla>> cargarArchivo(@RequestParam("file") MultipartFile file, HttpServletRequest  request){
		...
		try {
			...
			try(ByteArrayInputStream is = new ByteArrayInputStream(bytes);
				...
				if(!allItemsOk) {
					//respuesta.setObjetoRespuesta(listOfertas);
